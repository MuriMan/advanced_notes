...
\ce{O^{2-} (aq)},  become hydroxide ions, \ce{OH^- (aq)}. The oxide ions 
behave as bases by  accepting \ce{H^+} ions from water molecules. \emph{The 
